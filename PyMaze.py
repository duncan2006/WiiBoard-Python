    ...
    while self.keep_going:
      ...
      for event in pygame.event.get():
		   if event.type == KEYDOWN:
			   return
      scalesgui.wiimote.request_status()
      weight = (scalesgui.calcweight(scalesgui.wiimote.state['balance'], scalesgui.named_calibration) / 100.0)
      x_pos, y_pos = scalesgui.getpos()
      y_pos = -1.*y_pos
